                                ...
                                <div className="flex flex-col md:grid md:grid-cols-12 md:items-center p-6 gap-4">
                                    ...
                                    <div className="md:col-span-2 text-left">
                                        {student.custom_student_id ? (
                                            <span className="font-mono text-[10px] font-bold text-indigo-950 dark:text-indigo-200 bg-indigo-500/10 px-2.5 py-1 rounded-md border border-indigo-500/10">
                                                {student.custom_student_id}
                                            </span>
                                        ) : (
                                            <span className="text-muted-foreground/40 italic text-[10px]">No ID</span>
                                        )}
                                    </div>
